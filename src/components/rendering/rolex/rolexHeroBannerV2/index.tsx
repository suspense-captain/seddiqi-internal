...
const RolexHeroBannerV2 = ({ ...content }) => {
        ...
        return (
          <SwiperSlide className={`${slide?.media?.image && bannerSize && !slide?.mobileMedia?.media?.image && styles.swipeAuto} ${styles.swiperSlide}`} key={index}>
            <div className={`
              ${bannerSize && styles.smallBannerHeroSlider}
              ${styles.slide}
              ${!slide?.media?.image && !slide?.mobileMedia?.media?.image ? `${styles.noImage}` : ""}
              ${!slide?.media?.image && slide?.mobileMedia?.media?.image ? `${styles.noImageDesktop}` : ""}
              ${slide?.media?.image && !slide?.mobileMedia?.media?.image ? `${styles.noImageMobile}` : ""}
              `}>
              ...
              <div className={`${styles.textOverlay} ${(slide?.textPosition === "Center") ? styles.centerRolex : ""} ${styles[`${slide?.textColor?.toLowerCase()}-text`]}`}>

                  {slide?.title && <div className={`${styles.brand}`}>{slide?.title}</div>}
                  {slide?.subHeading && <h2 className={styles.title}>{slide?.subHeading}</h2>}
                  {slide?.description && 
                  <RichText align="" className={`${styles.description}`} text={slide?.description} />
                  }
                  {slide?.cta?.label && (
                ...
                <div className={`${styles.textOverlayCpo} ${slide?.textPosition === "Center" ? styles.centerCpo : ""} ${styles[`${slide?.textColor?.toLowerCase()}-text`]}`}>
                  {slide?.title && <div className={styles.brand}>{slide?.title}</div>}
                  {slide?.subHeading && <h2 className={styles.title}>{slide?.subHeading}</h2>}
                  {slide?.description && 
                  <RichText align="" className={`${styles.description}`} text={slide?.description} />
...
export default RolexHeroBannerV2;
