...
import styles from './bookAnAppointmentLocationTabs.module.scss';

const BookAnAppointmentLocationTabs = ({ activeTab, handleTabChange, tabs }) => {
  return (
...
export default BookAnAppointmentLocationTabs;